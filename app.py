...
fig_year = px.bar(df_year_count, x="Year", y="Application Count")
...
fig_status = px.bar(df_status_count, x="Current Status", y="Count")
...
app.layout = html.Div(children=[
    ...
    html.Div(children=[
        html.Div(children=[
            html.Br(),
            html.Br(),
            html.H3("What is the state of current short-term rental applications in New Orleans?"),
            '''
